...
<head>
    <title>Strategic Guarding | StarBulls</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="page-banner">
        ...
        <div class="page-name text-center">
            <h1 class="text-uppercase"><strong>Strategic Guarding</strong> </h1>
        </div>
