...
<head>
    <title>Facility Management | StarBulls</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="page-banner">
        ...
        <div class="page-name text-center">
            <h1 class="text-uppercase"><strong>Facility Management</strong> </h1>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 m-b-md">
                    <div class="serv-subcat">
                        ...
                        <div class="serv-subcat-overlay">
                            <div class="over-flex">
                                <p>Elevator & Escalator Attendant</p>
                            </div>
                        </div>
                    </div>
                </div>
